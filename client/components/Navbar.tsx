...
const Navbar = () => {
  return (
    <div className="h- w-screen flex flex-row align-middle px-0.5 py-0 shadow-box-shadow">
      ...
      <div className=" ml-auto font-medium text-lg flex sm:flex-col sm:text-xs ">
        <ul className="flex p-1 mx-0 my-5">
          ...
          <li className="mx-5 my-2 sm:mx-1">
            <Link
              href="/signup"
              className="p-3 rounded-3xl border border-kz-orange border-solid text-kz-orange box-border hover:text-[#ffffff] hover:border-[#ffffff] hover:bg-[#FF5F5F] transition-all duration-500 sm:p-"
            >
              Sign up/Login
            </Link>
          </li>
