                        ...
                        <div className="text-center">
                            ...
                            <div className="flex justify-center text-lg m-1">
                                <div className="flex flex-col sm:flex-row">
                                    <div className="flex px-2 justify-center items-center text-2xl sm:text-lg"><UserIcon className="pr-1 w-fit" />{frontmatter.username}</div>
                                    <div className="flex justify-center items-center text-base sm:text-lg">
                                        <div className="px-2 ">{frontmatter.date}</div>
                                        <div className="flex px-2"><Heart className="pr-1 w-fit" />{frontmatter.likeCount}</div>
                                    </div>
                                </div>
                            </div>
