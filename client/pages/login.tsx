    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
                <div className="bg-white rounded-2xl flex w-screen h-screen ">
                    <div className="flex w-5/12 bg-white">
                        <div className="w-full p-3">
                        <div className=" font-josefin_Sans h-full ">
                            <div className="h-1/2  justify-center relative">
                                <h1 className=" my-20 h-full w-588px h-160px left-373px top-200px font-extrabold text-transparent text-8xl bg-clip-text bg-gradient-to-r from-sky-400 from-10% via-green-500 via-20% to-red-400 to-35%">KZBlogs</h1>
                                <img src="bigCircles.svg" alt="bigCircles" className="absolute " />
                            </div>
                        </div>
                        </div>
                    </div>{/*Name*/}
                            ...
                            <div className=" w-5/12 h-4/6 rounded-xl bg-white px-10 pt-16 space-y-8 shadow-2xl outline outline-2 outline-red-200">
                                ...
                                <div>
                                    <div className="flex items-center justify-center">
                                        ...
                                        <div className=" m-2 tect-neutral-400 opacity-60">
                                            or
                                        </div>
                                        <hr className="my-12 h-0.5 w-full border-t-0 bg-neutral-400 opacity-50" />
                                    </div>
