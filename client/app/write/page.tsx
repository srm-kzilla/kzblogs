        ...
        <div className="p-2 justify-center h-full mt-8 px-5 md:px-24 lg:mt-16 lg:px-32 ">
          ...
          <form className="px-5">
            ...
            <div className="flex justify-evenly gap-20 text-white">
              <textarea
                className="outline-none border-none w-[40vw] h-[60vh] overflow-x-hidden text-base resize-none p-5 bg-kz-card-light rounded-2xl"
                value={markdownInput}
                placeholder="Type Away..."
                onChange={(e) => setMarkdownInput(e.target.value)}
              ></textarea>
              <div className="p-5 outline-none border-none w-[40vw] overflow-x-hidden text-base resize-none bg-kz-card-light rounded-xl">
                <ReactMarkdown
